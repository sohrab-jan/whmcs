...
{
    protected $title = 'فعالیت های کاربر';
    protected $description = 'کاربران آنلاین اخیر';
    protected $weight = 70;
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="item">
                ...
                <div class="data">
                    <div class="note">
                        <a href="clients.php?status=Active">کاربر فعال</a>
                    </div>
                    <div class="number">
                        <a href="clients.php?status=Active">
                            <span class="color-orange">{$activeClients}</span>
                            <span class="unit">فعال</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="item">
                ...
                <div class="data">
                    ...
                    <div class="number">
                        ...
                        <span class="unit">ساعات اخیر</span>
                    </div>
                </div>
            </div>
        </div>
