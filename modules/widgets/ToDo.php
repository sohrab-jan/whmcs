...
{
    protected $title = 'لیست کارهای روزانه';
    ...
    public function generateOutput($data)
    {
        ...
        foreach ($data as $key => $toDoItem) {
            ...
            if ($key == 10) {
                $output .= '<a href="todolist.php" class="view-more">مشاهده همه موارد</a>';
                continue;
            }
        ...
        if (count($data) == 0) {
            $output = '<div class="text-center">
                هیچ لیست کاری وجود ندارد .
                <br /><br />
                <a href="todolist.php" class="btn btn-primary btn-sm">افزودن لیست کار</a>
                <br /><br />
            </div>';
        }
